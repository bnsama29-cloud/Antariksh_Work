...
ax.set_title("Fig 3: Fungal Biomass Growth — Logistic ODE Model", color=BRIGHT, fontweight="bold")
...
ax.set_xlabel("Time (hr)")
ax.set_title("Fig 6: Radiation Attenuation — CH-2 vs CH-3 (vs CH-1 baseline)", color=BRIGHT, fontweight="bold")
ax.legend(handles=handles, fontsize=9, facecolor="#131727", edgecolor="#1e2540")
...
ax.set_xlabel("Time (hr)")
ax.set_title("Fig 5: OD600 Proxy — Auxiliary Computer Camera Simulation", color=BRIGHT, fontweight="bold")
ax.legend(handles=handles, fontsize=9, facecolor="#131727", edgecolor="#1e2540")
...
try:
    ...
    ax.set_xlabel("Time (hr)")
    ax.set_ylim(0, 7000)
    ax.set_title("Fig 7: Power Budget Feasibility (48h)", color=BRIGHT, fontweight="bold")
...
ax.set_xlabel("Time (hr)")
ax.set_title("Fig 2: Hysteresis Valve State Timeline", color=BRIGHT, fontweight="bold")
plt.tight_layout()
...
ax.set_ylabel("OD600 (Optical Density)")
ax.set_title("Fig 4: OD600 vs Biomass Linear Calibration", color=BRIGHT, fontweight="bold")
ax.legend(fontsize=9, facecolor="#131727", edgecolor="#1e2540")
plt.tight_layout()
